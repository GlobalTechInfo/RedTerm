...
alias kn='python /data/data/com.termux/files/home/keynote/keynote.py'
...
echo -e "\e[0;37m"
clear
echo ' ____    _____   ____    _____   _____   ____    __  __'
echo '|  _ \  | ____| |  _ \  |_   _| | ____| |  _ \  |  \/  |'
echo '| |_) | |  _|   | | | |   | |   |  _|   | |_) | | |\/| |'
echo '|  _ <  | |___  | |_| |   | |   | |___  |  _ <  | |  | |'
echo '|_| \_\ |_____| |____/    |_|   |_____| |_| \_\ |_|  |_|'
echo
echo
